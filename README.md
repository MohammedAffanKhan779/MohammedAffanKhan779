...
[![My Skills](https://skillicons.dev/icons?i=python,java,go,js,ts,react,nodejs,express,spring,mysql,mongodb,html,css,tailwind,vite,docker,jenkins,linux,git,github,opencv&theme=dark)](https://skillicons.dev)
